...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p f0d9af15-f599-4997-822f-a16f89b7e597
```

> `f0d9af15-f599-4997-822f-a16f89b7e597` is the password of the certificate, you can change it to any password you want.
